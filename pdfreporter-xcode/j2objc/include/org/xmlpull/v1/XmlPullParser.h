 ...
 */
inline NSString *OrgXmlpullV1XmlPullParser_get_NO_NAMESPACE();
...
/*!
 ...
 - seealso: #nextToken
 */
inline jint OrgXmlpullV1XmlPullParser_get_START_DOCUMENT();
...
/*!
 @brief Logical end of the xml document.
 Returned from getEventType, next()
 and nextToken()
 ...
 - seealso: #nextToken
 */
inline jint OrgXmlpullV1XmlPullParser_get_END_DOCUMENT();
 ...
 */
inline jint OrgXmlpullV1XmlPullParser_get_START_TAG();
...
/*!
 ...
 - seealso: #FEATURE_PROCESS_NAMESPACES
 */
inline jint OrgXmlpullV1XmlPullParser_get_END_TAG();
...
/*!
 ...
 - seealso: #getText
 */
inline jint OrgXmlpullV1XmlPullParser_get_TEXT();
...
/*!
 ...
 - seealso: #getText
 */
inline jint OrgXmlpullV1XmlPullParser_get_CDSECT();
...
/*!
 ...
 only.
 The entity name is available by calling getName(). If available,
 ...
 - seealso: #getText
 */
inline jint OrgXmlpullV1XmlPullParser_get_ENTITY_REF();
...
/*!
 ...
 - seealso: #getText
 */
inline jint OrgXmlpullV1XmlPullParser_get_IGNORABLE_WHITESPACE();
...
/*!
 @brief An XML processing instruction declaration was just read.
 This
 ...
 - seealso: #getText
 */
inline jint OrgXmlpullV1XmlPullParser_get_PROCESSING_INSTRUCTION();
...
/*!
 @brief An XML comment was just read.
 This event type is this token is
...
/*!
 ...
 - seealso: #getText
 */
inline jint OrgXmlpullV1XmlPullParser_get_DOCDECL();
 ...
 */
inline IOSObjectArray *OrgXmlpullV1XmlPullParser_get_TYPES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 ...
 namespaces.
 As for all features, the default value is false.
 <p><strong>NOTE:</strong> The value can not be changed during
 parsing an must be set before parsing.
 - seealso: #getFeature
 - seealso: #setFeature
 */
inline NSString *OrgXmlpullV1XmlPullParser_get_FEATURE_PROCESS_NAMESPACES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 ...
 - seealso: #setFeature
 */
inline NSString *OrgXmlpullV1XmlPullParser_get_FEATURE_REPORT_NAMESPACE_ATTRIBUTES();
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 ...
 - seealso: #setFeature
 */
inline NSString *OrgXmlpullV1XmlPullParser_get_FEATURE_PROCESS_DOCDECL();
/*! INTERNAL ONLY - Use accessor function from above. */
...
/*!
 ...
 - seealso: #setFeature
 */
inline NSString *OrgXmlpullV1XmlPullParser_get_FEATURE_VALIDATION();
/*! INTERNAL ONLY - Use accessor function from above. */
