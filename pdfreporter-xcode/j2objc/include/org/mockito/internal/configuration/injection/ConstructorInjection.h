...
FOUNDATION_EXPORT OrgMockitoInternalConfigurationInjectionConstructorInjection *create_OrgMockitoInternalConfigurationInjectionConstructorInjection_init();
