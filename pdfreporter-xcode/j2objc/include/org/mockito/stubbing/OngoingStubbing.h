...
/*!
 @brief Simply put: "<b>When</b> the x method is called <b>then</b> return y".
 E.g:
...
/*!
 @brief Sets a return value to be returned when the method is called.
 E.g:
 <pre class="code"><code class="java">
...
/*!
 @brief Sets consecutive return values to be returned when the method is called.
 E.g:
 <pre class="code"><code class="java">
 when(mock.someMethod()).thenReturn(1, 2, 3);
...
/*!
 @brief Sets Throwable objects to be thrown when the method is called.
 E.g:
 <pre class="code"><code class="java">
...
/*!
 @brief Sets Throwable classes to be thrown when the method is called.
 E.g:
 <pre class="code"><code class="java">
