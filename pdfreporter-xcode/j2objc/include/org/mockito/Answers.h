...
+ (OrgMockitoAnswers *)RETURNS_DEFAULTS;

+ (OrgMockitoAnswers *)RETURNS_SMART_NULLS;

+ (OrgMockitoAnswers *)RETURNS_MOCKS;

+ (OrgMockitoAnswers *)RETURNS_DEEP_STUBS;

+ (OrgMockitoAnswers *)CALLS_REAL_METHODS;
