...
/*!
 @brief Specifies extra interfaces the mock should implement.
 Might be useful for legacy code or some corner cases.
...
/*!
 @brief Specifies the instance to spy on.
 Makes sense only for spies/partial mocks.
...
/*!
 @brief Configures the mock to be serializable.
...
/*!
 @brief Enables real-time logging of method invocations on this mock.
 Can be used
...
/*!
 @brief Registers a listener for method invocations on this mock.
 The listener is
