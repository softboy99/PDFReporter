...
/*!
 @brief A set of assertion methods useful for writing tests.
...
/*!
 @brief Asserts that two char arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown.
...
/*!
 @brief Asserts that two double arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown.
...
/*!
 @brief Asserts that two float arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown.
...
/*!
 @brief Asserts that two int arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown.
...
/*!
 @brief Asserts that two long arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown.
...
/*!
 @brief Asserts that two object arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown. If <code>expected</code> and
...
/*!
 @brief Asserts that two short arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown.
...
/*!
 @brief Asserts that two object arrays are equal.
 If they are not, an
 <code>AssertionError</code> is thrown with the given message. If
...
/*!
 ...
 If they are not, an
 <code>AssertionError</code> without a message is thrown. If
...
/*!
 @brief Asserts that two longs are <b>not</b> equals.
 If they are, an
...
/*!
 @brief Asserts that two objects are <b>not</b> equals.
 If they are, an
 <code>AssertionError</code> without a message is thrown. If
...
/*!
 ...
 If it is an <code>AssertionError</code> is
 thrown.
...
/*!
 @brief Asserts that an object is null.
 If it is not, an <code>AssertionError</code>
...
/*!
 ...
 <code>matcher</code>.
 If not, an <code>AssertionError</code> is thrown with
...
FOUNDATION_EXPORT OrgJunitAssert *create_OrgJunitAssert_init();
