...
/*!
 ...
 Many users will never notice this
...
/*!
 @brief Returns the methods that run tests.
...
/*!
 @brief Returns a new fixture for running a test.
 Default implementation executes
...
/*!
 ...
 Override if a subclass requires
