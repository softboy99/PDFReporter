...
/*!
 @brief Annotates fields that reference rules or methods that return a rule.
 A field must be public, not
 static, and a subtype of <code>org.junit.rules.TestRule</code> (preferred) or
 <code>org.junit.rules.MethodRule</code>. A method must be public, not static,
