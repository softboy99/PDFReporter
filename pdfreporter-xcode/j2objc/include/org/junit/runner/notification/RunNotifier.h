...
/*!
 ...
 The Result's listener must be first.
 */
...
/*!
 @brief Invoke to tell listeners that an atomic test finished.
 Always invoke
...
/*!
 @brief Ask that the tests run stop before starting the next test.
 Phrased politely because
