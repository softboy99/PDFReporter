...
/*!
 ...
 In most cases the <code>org.junit.runner.Description</code>
...
FOUNDATION_EXPORT void OrgJunitRunnerNotificationFailure_initWithOrgJunitRunnerDescription_withNSException_(OrgJunitRunnerNotificationFailure *self, OrgJunitRunnerDescription *description_, NSException *thrownException);

FOUNDATION_EXPORT OrgJunitRunnerNotificationFailure *new_OrgJunitRunnerNotificationFailure_initWithOrgJunitRunnerDescription_withNSException_(OrgJunitRunnerDescription *description_, NSException *thrownException) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT OrgJunitRunnerNotificationFailure *create_OrgJunitRunnerNotificationFailure_initWithOrgJunitRunnerDescription_withNSException_(OrgJunitRunnerDescription *description_, NSException *thrownException);
