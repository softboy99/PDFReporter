...
/*!
 ...
 or flags.<p>
 */
inline jint AndroidTextInputType_get_TYPE_MASK_CLASS();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_MASK_VARIATION();
...
/*!
 ...
 of options.
 */
inline jint AndroidTextInputType_get_TYPE_MASK_FLAGS();
...
/*!
 ...
 flag is set.
 */
inline jint AndroidTextInputType_get_TYPE_NULL();
#define AndroidTextInputType_TYPE_NULL 0
J2OBJC_STATIC_FIELD_CONSTANT(AndroidTextInputType, TYPE_NULL, jint)

/*!
 @brief Class for normal text.
 This class supports the following flags (only
 ...
 */
inline jint AndroidTextInputType_get_TYPE_CLASS_TEXT();
#define AndroidTextInputType_TYPE_CLASS_TEXT 1
J2OBJC_STATIC_FIELD_CONSTANT(AndroidTextInputType, TYPE_CLASS_TEXT, jint)

/*!
 @brief Flag for <code>TYPE_CLASS_TEXT</code>: capitalize all characters.
 Overrides
 <code>TYPE_TEXT_FLAG_CAP_WORDS</code> and
 <code>TYPE_TEXT_FLAG_CAP_SENTENCES</code>.  This value is explicitly defined
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_CAP_CHARACTERS();
...
/*!
 ...
 every word.
 Overrides <code>TYPE_TEXT_FLAG_CAP_SENTENCES</code>.  This
 value is explicitly defined
 to be the same as <code>TextUtils.CAP_MODE_WORDS</code>. Of course,
 this only affects languages where there are upper-case and lower-case letters.
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_CAP_WORDS();
...
/*!
 ...
 to be the same as <code>TextUtils.CAP_MODE_SENTENCES</code>. For example
 ...
 this only affects languages where there are upper-case and lower-case letters.
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_CAP_SENTENCES();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_AUTO_CORRECT();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_AUTO_COMPLETE();
...
/*!
 ...
 If this flag is not set, the text field 
 will be constrained to a single line. The IME may also choose not to
 display an enter key when this flag is not set, as there should be no
 need to create new lines.
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_MULTI_LINE();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_IME_MULTI_LINE();
...
/*!
 ...
 This is useful for text views that
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_FLAG_NO_SUGGESTIONS();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_NORMAL();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_URI();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_EMAIL_ADDRESS();
...
/*!
 ...
 an e-mail.
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_EMAIL_SUBJECT();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_SHORT_MESSAGE();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_LONG_MESSAGE();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_PERSON_NAME();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_POSTAL_ADDRESS();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_PASSWORD();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_VISIBLE_PASSWORD();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_WEB_EDIT_TEXT();
...
/*!
 ...
 of a list etc.
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_FILTER();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_PHONETIC();
...
/*!
 ...
 of a web form.
 This was added in HONEYCOMB.  An IME must target
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_WEB_EMAIL_ADDRESS();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_TEXT_VARIATION_WEB_PASSWORD();
...
/*!
 @brief Class for numeric text.
 This class supports the following flags:
 <code>TYPE_NUMBER_FLAG_SIGNED</code> and
 <code>TYPE_NUMBER_FLAG_DECIMAL</code>.  It also supports the following
 ...
 */
inline jint AndroidTextInputType_get_TYPE_CLASS_NUMBER();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_NUMBER_FLAG_SIGNED();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_NUMBER_FLAG_DECIMAL();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_NUMBER_VARIATION_NORMAL();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_NUMBER_VARIATION_PASSWORD();
...
/*!
 @brief Class for a phone number.
 This class currently supports no variations
 or flags.
 */
inline jint AndroidTextInputType_get_TYPE_CLASS_PHONE();
#define AndroidTextInputType_TYPE_CLASS_PHONE 3
J2OBJC_STATIC_FIELD_CONSTANT(AndroidTextInputType, TYPE_CLASS_PHONE, jint)

/*!
 @brief Class for dates and times.
 It supports the
 following variations:
 ...
 */
inline jint AndroidTextInputType_get_TYPE_CLASS_DATETIME();
 ...
 */
inline jint AndroidTextInputType_get_TYPE_DATETIME_VARIATION_NORMAL();
...
/*!
 ...
 only a date.
 */
inline jint AndroidTextInputType_get_TYPE_DATETIME_VARIATION_DATE();
...
/*!
 ...
 only a time.
 */
inline jint AndroidTextInputType_get_TYPE_DATETIME_VARIATION_TIME();
