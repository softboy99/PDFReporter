...
/*!
 @brief Starts a test run.
 Analyzes the command line arguments and runs the given
 test suite.
 */
...
FOUNDATION_EXPORT JunitTextuiTestRunner *create_JunitTextuiTestRunner_init();
