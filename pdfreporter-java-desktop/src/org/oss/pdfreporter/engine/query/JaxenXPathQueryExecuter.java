...
import org.oss.pdfreporter.engine.data.JaxenXmlDataSource;
 ...
 * {@link org.oss.pdfreporter.engine.query.JaxenXPathQueryExecuterFactory#PARAMETER_XML_DATA_DOCUMENT PARAMETER_XML_DATA_DOCUMENT}
 * parameter.
 * <p/>
 ...
 * @version $Id: JaxenXPathQueryExecuter.java 5576 2012-08-16 09:04:00Z lucianc $
 */
public class JaxenXPathQueryExecuter extends JRAbstractQueryExecuter
{
	...
	public JRDataSource createDatasource() throws JRException
	{
		...
		if (document != null && xPath != null)
		{
			...
			datasource.setLocale((StringLocale)getParameterValue(JaxenXPathQueryExecuterFactory.XML_LOCALE, true));
