...
import org.oss.pdfreporter.engine.fill.JRFiller;
 ...
 * <ul>
 * <li>Methods that receive an instance of the {@link org.oss.pdfreporter.engine.JRDataSource} interface
 * and use it directly for retrieving report data;
 * <li>Methods that receive an instance of the {@link org.oss.pdfreporter.sql.IConnection} interface and retrieve
 * the report data by executing the report internal SQL query through this SQL connection and wrapping 
 * the returned {@link org.oss.pdfreporter.sql.IResultSet} object inside a {@link org.oss.pdfreporter.engine.JRResultSetDataSource}
 * instance. 
 * </ul>
 * 
 * @see org.oss.pdfreporter.engine.JasperReport
 * @see org.oss.pdfreporter.engine.JRDataSource
 * @see org.oss.pdfreporter.engine.fill.JRFiller
 * @see org.oss.pdfreporter.engine.JasperPrint
 * @author Teodor Danciu (teodord@users.sourceforge.net)
 * @version $Id: JasperFillManager.java 5180 2012-03-29 13:23:12Z teodord $
 */
public final class JasperFillManager
{
	private final static Logger logger = Logger.getLogger(JasperFillManager.class.getName());
	...
	/**
	 * @see #fillToFile(String, Map, IConnection)
	 */
	...
	/**
	 * @see #fillToFile(String, String, Map, IConnection)
	 */
	...
	/**
	 * @see #fillToFile(JasperReport, String, Map, IConnection)
	 */
	public static void fillReportToFile(
		JasperReport jasperReport, 
		String destFileName, 
	...
	/**
	 * @see #fill(String, Map, IConnection)
	 */
	...
	/**
	 * @see #fillToStream(InputStream, OutputStream, Map, IConnection)
	 */
	...
	/**
	 * @see #fillToStream(JasperReport, OutputStream, Map, IConnection)
	 */
	public static void fillReportToStream(
		JasperReport jasperReport, 
		OutputStream outputStream, 
	...
	/**
	 * @see #fill(InputStream, Map, IConnection)
	 */
	public static JasperPrint fillReport(
		InputStream inputStream, 
		Map<String,Object> parameters,
	...
	/**
	 * @see #fill(JasperReport, Map, IConnection)
	 */
	public static JasperPrint fillReport(
		JasperReport jasperReport, 
		Map<String,Object> parameters, 
	...
	{
		ProgressManager pm = new ProgressManager(ProgressState.FILLING);
		try {
