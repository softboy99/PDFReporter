 ...
 * @version $Id: JRFillDataset.java 5502 2012-07-24 12:12:00Z lucianc $
 */
public class JRFillDataset implements JRDataset, DatasetFillContext
{
	...
	{
		JREvaluator evaluator = (JREvaluator) JasperCompileManager.getInstance(jasperReportsContext).getEvaluator(jasperReport, dataset);
	...
	{
		IJRFillParameter paramValuesParameter = parametersMap.get(JRParameter.REPORT_PARAMETERS_MAP);
	 ...
	 */
	public void setConnectionParameterValue(Map<String,Object> parameterValues, IConnection conn)
	{
	...
	{
		cacheRecordCount = cacheRecordCount + 1;
	...
	{
		IJRFillParameter parameter = parametersMap.get(parameterName);
		if (parameter != null)
		{
			setParameter(parameter, value);
		}
	 ...
	 * @throws JRException
	 */
	protected void setParameter(IJRFillParameter parameter, Object value) throws JRException
	{
//		if (value != null)
//		{
...
//		}
	...
	{
		IJRFillParameter param = parametersMap.get(parameterName);
		Object value;
		if (param == null)
		{
			if (!ignoreMissing)
	...
	{
		void cacheRecordIndexAvailable(Integer recordIndex);
	}

	protected static class FillDatasetPositionRecordIndexCallback implements CacheRecordIndexCallback
	{
		protected static void setRecordIndex(FillDatasetPosition position, Integer recordIndex)
		{
		...
		@Override
		public void cacheRecordIndexAvailable(Integer recordIndex)
		{
